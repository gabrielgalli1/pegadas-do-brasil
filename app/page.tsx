...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setNickname(window.localStorage.getItem("pegadas-nickname"));
  ...
  async function submitNickname(event: React.FormEvent) {
    ...
    if (trimmed.length < 2 || trimmed.length > 15) {
      setNicknameError("O apelido deve ter entre 2 e 15 letras.");
      return;
    }
    if (!NICKNAME_PATTERN.test(trimmed)) {
      setNicknameError("Use só letras, números e espaços — sem símbolos.");
      return;
    }
